...
import com.example.gd10_a_08865.databinding.ActivityFormAddMahasiswaBinding
...
class FormAddMahasiswaActivity : AppCompatActivity() {
    ...
    fun saveData(){
        with(binding) {
            ...
            RClient.instances.createData(nobp,nama,alamat,prodi,lahir).enqueue(
                object : Callback<ResponseCreate> {
